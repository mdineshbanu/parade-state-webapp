...
document.getElementById('paradeForm').addEventListener('submit', async function (e) {
  ...
  const response = await fetch("https://script.google.com/macros/s/AKfycbxZ2jfncDCRXrPvOK07VX5TmPocv6QJzjVcNVe8b3oKRbRaeWJOszqhQDi6nBiQViGr/exec", {
    method: "POST",
...
async function loadDataTable() {
  const res = await fetch("https://script.google.com/macros/s/AKfycbxZ2jfncDCRXrPvOK07VX5TmPocv6QJzjVcNVe8b3oKRbRaeWJOszqhQDi6nBiQViGr/exec");
