...
document.getElementById('paradeForm').addEventListener('submit', async function (e) {
  ...
  const response = await fetch("https://script.google.com/macros/s/AKfycbwPxWgDhQ09PSjb3JCZ8hFHhvZnpBVxnyglNNfiUK7JK0T8DRo3emzJpGg6f3u0OyOw/exec", {
    method: "POST",
...
async function loadDataTable() {
  const res = await fetch("https://script.google.com/macros/s/AKfycbwPxWgDhQ09PSjb3JCZ8hFHhvZnpBVxnyglNNfiUK7JK0T8DRo3emzJpGg6f3u0OyOw/exec");
